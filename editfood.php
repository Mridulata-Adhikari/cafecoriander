...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/editfood.css">
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "SELECT * FROM food ORDER BY foodId");
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='editfood.php?update= {$row['foodId']}'>{$row['foodname']}</a></b>";  
        ?>
      </div>
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM food WHERE foodId=$update");
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input class='input' type='hidden' name="dfoodId" value=<?php echo $row1['foodId'];  ?> />
          </div>

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Food Name: </label>
            <input type="text" class="form-control" id="dfoodname" name="dfoodname" value=<?php echo $row1['foodname'];  ?> placeholder="Your Food name" required="">
          </div>     
