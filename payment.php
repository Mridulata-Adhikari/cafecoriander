...
<h2 class="text-center"> Thank you for shopping at Cafe Coriander!</h2>


<h3 class="text-center"><p>Order id:<?php echo $ordid; ?></p></span> </h3>
 <p style="text-align: center;"><a href="custordersdet.php" s><button >Show order details</button></a> </p>

   <?php $_SESSION['order'] = $ordid;
 ?>  
  </div>
    </div>
  </div>
